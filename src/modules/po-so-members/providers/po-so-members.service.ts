...
export class PoSoMembersService {
  ...
  async assign(dto: AssignPoSoMemberDto, userId: number): Promise<BaseResponseDto<PoSoMemberResponseDto>> {
  ...
  async updateActuals(id: number, actualMandays: number, userId: number): Promise<BaseResponseDto<PoSoMemberResponseDto>> {
