...
export class UsersController {
  ...
  @ApiBaseResponse(UserResponseDto)
  create(@Body() dto: CreateUserDto, @CurrentUser() user: any): Promise<BaseResponseDto<UserResponseDto>> {
  ...
  @ApiBaseResponse(UserResponseDto)
  update(@Param('id') id: string, @Body() dto: UpdateUserDto): Promise<BaseResponseDto<UserResponseDto>> {
