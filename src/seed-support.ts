...
const rawTickets: RawSupportTicket[] = [
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Alvin Syarifudin Shahab',
    issue: 'Membantu FE Tsel inject attachment untuk perbaikan attachment corrupt',
    hours: 4,
    status: 'Done',
    platform: 'OS',
    startDate: '19-Sep-25',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Alvin Syarifudin Shahab',
    issue: 'Ubah copywriting dan menambahkan kondisi sesuai dengan jenis benefit dan perbaikan page detail BTKMP Yakes dengan menambahkan dokumen baru',
    hours: 4,
    status: 'Done',
    platform: 'OS',
    startDate: '18-Sep-25',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Alvin Syarifudin Shahab',
    issue: 'Cek api cubes profile dengan user dan team ebs oracle karena balance selalus 0',
    hours: 7,
    status: 'Done',
    platform: 'OS',
    startDate: '15-Sep-25',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Alvin Syarifudin Shahab',
    issue: 'Perubahan logic tampilan manfaat pensiun berdasarkan formula terbaru',
    hours: 4,
    status: 'Done',
    platform: 'OS',
    startDate: '08-Sep-25',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Alvin Syarifudin Shahab',
    issue: 'Cek log error internal server karena panjang kolom pada table tidak sesuai',
    hours: 4,
    status: 'Done',
    platform: 'OS',
    startDate: '01-Sep-25',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Alvin Syarifudin Shahab',
    issue: 'Melakukan identifikasi terhadap error api withdraw leave karena absence id null',
    hours: 2,
    status: 'Done',
    platform: 'OS',
    startDate: '11-Aug-25',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Alvin Syarifudin Shahab',
    issue: "Wording Leave Type 'Ijin Karena Sakit' berubah menjadi 'Ijin Karena Keperluan Pribadi' ketika belum upload attachment",
    hours: 6,
    status: 'Done',
    platform: 'OS',
    startDate: '02-Jul-25',
  ...
  },
  {
    ...
    issue: 'Penambahan kolom Username pada menu Role user di Backoffice Polaris',
    hours: 2,
    status: 'Done',
    platform: 'OS',
    startDate: '20-Nov-25',
  ...
  },
  {
    ...
    notes: 'SIT by user done. Confirmed dari user di hold di dev dulu (belum perlu publish ke prod).'
  },
  {
    no: 2,
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Mas Royan',
    issue: 'Hide field input feedback notes & update wording untuk popup Feedback to Direct Leader',
    hours: 2,
    status: 'Done',
    platform: 'OS',
    startDate: '27-Feb-26',
  ...
  },
  {
    ...
    issue: 'Update query API list employee dari "superior" ke "name" untuk get list all superior untuk popup edit superior ketika status masih not started & edit superior di dalam detail employee',
    hours: 3,
    status: 'Done',
    platform: 'OS',
    startDate: '29-Apr-26',
  ...
  },
  {
    ...
    details: [
      ...
      {
        subIssue: 'Menambahkan filter dan sort pada kolom tgl lahir, nik, nama dan membuat halaman sijep moniroting untuk karyawan sudah pensiun',
        hoursSpent: 8,
        status: 'DONE',
        startDate: '18-May-26',
        endDate: '18-May-26',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Raihan Jana Prasetya',
    issue: 'Hide submenu Employee Profile & Working Principle dari all form (form non ai, form meeting ai, form update admin)',
    hours: 1,
    status: 'Done',
    platform: 'OS',
    startDate: '25-May-26',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Mas Alvin',
    issue: 'Menambahkan validasi marriage book dan upload attachment marriage book',
    hours: 8,
    status: 'Done',
    platform: 'Nestjs',
    startDate: '15-Jan-26',
  ...
  },
  {
    ...
    soNumber: 'X-SO-XXX',
    customer: 'Mas Alvin',
    issue: 'Update api edit contact biar menggunakan effective date ketika type OTHER',
    hours: 4,
    status: 'Done',
    platform: 'Nestjs',
    startDate: '23-Mar-26',
...
function mapStatus(statusStr: string): SupportTicketStatus {
  ...
  if (s === 'ON PROGRESS DEVELOPMENT' || s === 'IN PROGRESS') return SupportTicketStatus.IN_PROGRESS;
...
function mapDetailStatus(statusStr: string): SupportTicketDetailStatus {
  ...
  if (s === 'ON PROGRESS DEVELOPMENT' || s === 'IN PROGRESS') return SupportTicketDetailStatus.IN_PROGRESS;
